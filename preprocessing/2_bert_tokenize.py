...
- Input folder: cleaned_datasets
- Output folder: tokenized_datasets
'''
...
df = pd.read_csv('cleaned_datasets/'+name+'.csv') 
#print(df.head())
...
df['limit'] = limit
df.to_csv('tokenized_datasets/'+name+'.csv', index=False)